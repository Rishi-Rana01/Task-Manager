    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-slide-up">
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold cursor-pointer transition-all text-emerald-500 dark:text-emerald-400 hover:bg-emerald-500/10"
        >
          <CheckCheck size={14} />
          Complete
        </button>
        ...
        <div className="relative group">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold cursor-pointer transition-all text-amber-500 dark:text-amber-400 hover:bg-amber-500/10"
          >
            <Flag size={14} />
            Priority
          </button>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold cursor-pointer transition-all text-red-500 dark:text-red-400 hover:bg-red-500/10"
        >
          <Trash2 size={14} />
          Delete
        </button>
